...
//                                Main.socketController.connectedServer.port))));
      ...
      //  leftPanel.add(connectedServerInfoJList, gbc.setGrid(1, 1).setWeight(1, 0).setFill(GridBagConstraints.BOTH));
        ...
        enterMessagePanel.setBackground(Color.red);
        ...
        messageArea.setBorder(BorderFactory.createLineBorder(Color.blue, 1, true));
...
//        roomUsersJList.setBorder(BorderFactory.createTitledBorder("User trong room hiện tại"));
        ...
        //danh sách usser online
        JSplitPane roomSplitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, chatPanel,chatSubjectSplitPane);
        roomSplitPane.setDividerLocation(450);
        JSplitPane mainSplitpane = new JSplitPane(JSplitPane.WHEN_FOCUSED, null, roomSplitPane);
